...
export const USER_ROLES: Record<string, UserRole> = {
  ...
  ADMIN: {
    ...
    permissions: [
      ...
      PERMISSIONS.AUTHORIZATION_MANAGE, // Add this
    ],
    defaultRoute: "/",
  },
  ...
  QA_NURSE: {
    ...
    permissions: [
      ...
      PERMISSIONS.AUTHORIZATION_VIEW, // Add this
    ],
    defaultRoute: "/quality",
  },
  ...
  NURSE_MANAGER: {
    ...
    permissions: [
      ...
      PERMISSIONS.PATIENT_VIEW,
      PERMISSIONS.QA_VIEW,
      PERMISSIONS.AUTHORIZATION_TRACK, // Add this
    ],
...
export function canAccessRoute(user: User, route: string): boolean {
  const routePermissions: Record<string, { resource: string; action: string }> = {
    ...
    "/referral-management": { resource: "applications", action: "read" }, // Add this
  }

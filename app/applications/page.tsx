  ...
  const applications = [
    {
      ...
      notes: "Strong clinical background in home care",
      documents: {
        resume: "uploaded",
        license: "pending",
        references: "uploaded",
      ...
      timeline: [
        { date: "2024-01-15", action: "Application submitted", user: "System" },
        { date: "2024-01-15", action: "Initial screening pending", user: "HR Team" },
      ],
    },
    {
      id: "APP-002",
      ...
      experience: "8 years",
      education: "DPT - Wayne State University",
      ...
      timeline: [
        { date: "2024-01-12", action: "Application submitted", user: "System" },
        { date: "2024-01-13", action: "Initial screening completed", user: "Jane Smith" },
        { date: "2024-01-14", action: "Documents reviewed", user: "HR Team" },
      ],
    },
    {
      id: "APP-003",
      ...
      experience: "3 years",
      education: "MS OT - Eastern Michigan University",
      notes: "Scheduled for interview on 1/18",
      documents: {
        resume: "uploaded",
        license: "verified",
        references: "uploaded",
      ...
      timeline: [
        { date: "2024-01-10", action: "Application submitted", user: "System" },
        { date: "2024-01-11", action: "Initial screening completed", user: "Jane Smith" },
        { date: "2024-01-12", action: "Phone screening passed", user: "Dr. Wilson" },
        { date: "2024-01-13", action: "Interview scheduled", user: "HR Team" },
      ],
    },
    {
      id: "APP-004",
      ...
      experience: "2 years",
      education: "High School Diploma + CNA Certificate",
      ...
      timeline: [
        { date: "2024-01-08", action: "Application submitted", user: "System" },
        { date: "2024-01-09", action: "Initial screening completed", user: "Jane Smith" },
        { date: "2024-01-10", action: "Interview completed", user: "Dr. Wilson" },
        { date: "2024-01-12", action: "Background check initiated", user: "HR Team" },
      ],
    },
    {
      id: "APP-005",
      ...
      phone: "(555) 567-8901",
      position: "Master of Social Work (MSW)",
      status: "hired",
      appliedDate: "2024-01-05",
      lastActivity: "2024-01-14",
      experience: "6 years",
      education: "MSW - University of Michigan",
      notes: "Offer accepted, start date 1/22",
      documents: {
        resume: "uploaded",
        license: "verified",
        references: "uploaded",
      ...
      timeline: [
        { date: "2024-01-05", action: "Application submitted", user: "System" },
        { date: "2024-01-06", action: "Initial screening completed", user: "Jane Smith" },
        { date: "2024-01-08", action: "Interview completed", user: "Dr. Wilson" },
        { date: "2024-01-10", action: "Background check completed", user: "HR Team" },
        { date: "2024-01-12", action: "Offer extended", user: "HR Team" },
        { date: "2024-01-14", action: "Offer accepted", user: "Lisa Garcia" },
      ],
    },
  ]
